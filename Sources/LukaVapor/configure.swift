...
public func configure(_ app: Application) async throws {
    ...
    // Configure APNS
    guard let pemString = Environment.get("PUSH_NOTIFICATION_PEM"),
          let keyID = Environment.get("PUSH_NOTIFICATION_ID"),
          let teamID = Environment.get("TEAM_IDENTIFIER") else {
        throw Abort(.internalServerError, reason: "Missing APNS environment variables")
    }
